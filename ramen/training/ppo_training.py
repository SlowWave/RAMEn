...
def train(
    ...
    if resume_training:
        ...
        # TODO: Evaluate how to add these options using available modules
    ...
    env_id_str = env_class.__module__.split(".")[-2]
    model_str = "PPO" + experiment_info_str
    file_name = model_str + "_" + datetime_str
    output_filepath = os.path.join(os.path.dirname(__file__), "experiments", env_id_str, file_name)
...
if __name__ == "__main__":
    ...
    from environments.lorenz_system.environment import LorenzEnv
